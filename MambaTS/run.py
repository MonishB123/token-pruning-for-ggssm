...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--results", type=str, default="./results", help="location of model checkpoints"
    )
    ...
    parser.add_argument(
        "--max_pred_len", type=int, default=-1, help="prediction sequence length"
    )
    parser.add_argument(
    ...
    # PatchTST
    parser.add_argument(
        "--patch_len", type=int, default=None, help="prediction sequence length"
    )
    parser.add_argument(
        "--stride", type=int, default=None, help="prediction sequence length"
    )
