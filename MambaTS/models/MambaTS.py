...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        # Encoder
        from layers.mamba_ssm.mixer2_seq_simple import MixerTSModel as TemporalGraphSSM

        self.encoder = TemporalGraphSSM(
        ...
        self.head = PredictionHead(
            configs.d_model * configs.seq_len // configs.patch_len, configs.pred_len
        )
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        # Encoder
        enc_out, attns = self.encoder(enc_in, context_len=enc_in.size(1))
